...
public abstract class Classifier {
  ...
  public static Classifier create(Activity activity, Model model, Device device, int numThreads)
    ...
    } else if (model == Model.PRUNED_MOBILENET) {
      return new ClassifierPrunedMobileNet(activity, device, numThreads);
    } else if (model == Model.CLUSTERED_MOBILENET) {
      return new ClassifierClusteredMobileNet(activity, device, numThreads);
    } else {
